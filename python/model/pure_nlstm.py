...
from python.operator import nlstm_aligned, connectivity
from python.model.abstact import AbstactModel

dirname = path.dirname(path.realpath(__file__))


class PureNLSTM(AbstactModel):
    def __init__(self, dataset, name='pure_nlstm',
                 embedding_size=1200, **kwargs):
        super().__init__(
            dataset,
            params={
    ...
    def _model_fn(self, features, labels, mode, params):
        ...
        logits, embedding, embedding_matrix = nlstm_aligned(
            source, length,
